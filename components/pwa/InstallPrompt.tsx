              ...
              <div className="p-4">
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button
                    ...
                    className="flex-1 py-3 px-4 text-sm font-medium text-white bg-rose-500 rounded-xl hover:bg-rose-600 transition-colors flex items-center justify-center gap-2"
                  >
            ...
            >
              ...
              <div className="px-6 pb-8">
                ...
                <button
                  ...
                  className="w-full mt-8 py-4 text-white font-bold bg-rose-500 rounded-xl hover:bg-rose-600 transition-colors"
                >
                  Begrepen
                </button>
              </div>
