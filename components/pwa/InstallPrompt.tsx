              ...
              <div className="p-4">
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button
                    ...
                    className="flex-1 py-3 px-4 text-sm font-medium text-white bg-primary rounded-xl hover:bg-primary-hover transition-colors flex items-center justify-center gap-2"
                  >
            ...
            >
              ...
              <div className="px-6 pb-8">
                ...
                <button
                  ...
                  className="w-full mt-8 py-4 text-white font-bold bg-primary rounded-xl hover:bg-primary-hover transition-colors"
                >
                  Begrepen
                </button>
              </div>
