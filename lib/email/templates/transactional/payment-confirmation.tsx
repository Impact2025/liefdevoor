...
export default function PaymentConfirmationEmail({
  ...
  renewalDate = '26 januari 2026',
  discoverUrl = 'https://liefdevooriedereen.nl/discover'
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.text}>
              Bedankt voor je aankoop! Je {planName} abonnement is nu actief en je hebt toegang tot alle premium functies.
            </Text>

            {/* Payment Details */}
            <Section style={styles.detailsBox}>
              <Text style={styles.detailsTitle}>Betalingsgegevens</Text>
              <Hr style={styles.hr} />
              ...
              <table style={styles.detailsTable}>
                ...
                {renewalDate && (
                  <tr>
                    <td style={styles.detailLabel}>Verlengt op</td>
            ...
            <Section style={styles.ctaSection}>
              <Button href={discoverUrl} style={styles.button}>
                Begin met daten
              </Button>
            </Section>

            <Text style={styles.mutedText}>
              Je facturatiegegevens en abonnementsinstellingen kun je altijd beheren in je accountinstellingen.
            </Text>
          </Section>
